...
public class VistaConsultarAdministrador extends VistaBase {
    // Campos de texto de la vista para consultar administradores
    ...
    public VistaConsultarAdministrador(){
        super("Consultar Administrador");
    ...
    public void inicializarComponentes(){
        ...
        btnRegresar.setBounds(180, 390, 150, 40);
